module RecordsHelper
	def correctlink(record, rec = nil)
		if rec.nil?
		 	...
		 	if current_user.id == record.loanofficer_id or current_user.id == record.processor_id or current_user.profile.title == "admin" or current_user.profile.title == "master" or current_user.id == record.real_id or current_user.id == record.escrow_id
